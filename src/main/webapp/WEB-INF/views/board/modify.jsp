...
<%--				<button type="submit" class="btn btn-sm btn-primary" ><a data-toggle="modal" data-target="#thumbnail-modal">수정</a></button>--%>
				<!--<button class="btn btn-sm btn-primary" onclick="return validateForm();"><a data-toggle="modal" data-target="#thumbnail-modal">수정</a></button>-->
...
<script>
	...
	function submit(){
		...
		$("#updateColumn").children().eq(3).attr("value",$title);
		$("#updateColumn").children().eq(4).attr("value",content);
		//form을 submit하기
