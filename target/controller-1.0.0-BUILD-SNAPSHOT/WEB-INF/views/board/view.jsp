			...
			<div class="column-header">
				<div class="content-header">
					...
					<div class="content-header-top">
						<h4><b>${view.title}</b></h4>
						<button class="btn btn-sm btn-primary" onclick="location.href='/postscript/write?bno=${view.bno}'">후기작성</button>
						<button class="btn btn-sm btn-primary" onclick="location.href='/postscript/postlist?bno=${view.bno}'">후기보기</button>
					</div>
			...
			<form method="post" action="/reply/write">
				<div class="row">
					...
					<div class="mb-3">
						...
						<button type="submit" class="btn btn-sm btn-primary" id="btnReplySave">댓글 작성</button>
					</div>
				</div>
			</form>
			</c:if>
					...
					<div class="row justify-content-center">
						<div class="col-xl-6">
							<div class="text-center">
								...
								<a href="/"><img src="../../../resources/img/tomain.png"></a>
							</div>
						</div>
					</div>
				</div>
